...
export const metadata: Metadata = {
    ...
    alternates: {
        ...
        languages: {
            'fr-TN': siteConfig.url.baseUrl,
        },
    },
    openGraph: {
        title: `Location Voiture Tunisie dès ${siteConfig.pricing.minPrice3Days} ${siteConfig.pricing.currencyDisplay}/3 jours | ${siteConfig.brand.name}`,
        description: `Location de voiture en Tunisie dès ${siteConfig.pricing.minPrice3Days} ${siteConfig.pricing.currencyDisplay} pour 3 jours. Sans carte bancaire, payez à l'arrivée. Service 24h/24.`,
        type: "website",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: `${siteConfig.brand.name} - Location Voiture Tunisie`,
            }
        ],
    },
    twitter: {
        ...
        title: `Location Voiture Tunisie dès ${siteConfig.pricing.minPrice3Days} ${siteConfig.pricing.currencyDisplay}/3 jours | ${siteConfig.brand.name}`,
        description: `Location de voiture en Tunisie dès ${siteConfig.pricing.minPrice3Days} ${siteConfig.pricing.currencyDisplay} pour 3 jours. Sans carte bancaire, payez à l'arrivée.`,
        images: [ogImageUrl],
    },
    verification: {
