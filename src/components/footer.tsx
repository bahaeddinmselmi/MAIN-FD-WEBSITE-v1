            ...
            <div className="max-w-screen-2xl mx-auto px-6 md:px-12 py-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                    ...
                    <div>
                        ...
                        <p className="text-slate-300 mb-8 max-w-xs text-sm leading-relaxed">
                            Location de voitures en Tunisie avec livraison gratuite
                            à l&apos;aéroport et aux hôtels. Sans carte bancaire, paiement
                            à l&apos;arrivée.
                        </p>
                        {/* Social icons */}
                ...
                <div className="mt-20 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-slate-400 text-xs">
                        &copy; {siteConfig.brand.foundingYear} - {new Date().getFullYear()} {siteConfig.brand.name}. Tous droits réservés.
                    </p>
